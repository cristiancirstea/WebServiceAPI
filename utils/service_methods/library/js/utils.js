    ...
    if (idParinte!==undefined && idParinte!=="")
    ...
    else
        {
            ...
            if (IsMobile())
                ...
                {
                   $("body").append("<div  style='position:fixed;top:5px;left:30%;z-index:999; width:40%;min-width:100px;'>\n\
...
function ActivateEditor(idElem,theme){
    if (typeof(theme)=='undefined'){
       theme = 'clouds';  
    }
    var editor = ace.edit(idElem);
    var fileType = $("#"+idElem).attr("fileType");
